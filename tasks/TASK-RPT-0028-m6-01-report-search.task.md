...
讓三人小隊可用 Qutora 搬移後 metadata 搜尋報表，並驗證角色、Data Scope、機密等級與下載閘道銜接。
...
| --- | --- | --- |
| V-0028-01 | 驗證 報表查詢與 Data Scope 套用 規格包含 Qutora 輸入、MariaDB 輸出與 evidence 路徑。 | `evidence/Pilot/TASK-RPT-0028/V-0028-01.md` |
...
| V-0028-10 | 驗證 `git diff --check` 無格式錯誤。 | `evidence/Pilot/TASK-RPT-0028/V-0028-10.md` |
...
| TC-0028-10 | rollback / 回復情境 | 依 RB-04 或任務 rollback 執行 | 可回到 Qutora 或安全狀態 | 回復路徑不可用 |
